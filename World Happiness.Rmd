...
Generosity: the scale of absence of corruption

Perceptions of corruption: the scale of generosity.

# Explanatory analysis {#sec:Explan}

This code ceates summary statistics. The mean, SD, quantiles, min, max and median values are all calculated.
